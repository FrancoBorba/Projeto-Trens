...
* Nome.............: ThreadTrem2
* Funcao...........: Criar e configurar a Thread que movimentara os trens da direita
*************************************************************** */
package model;
...
public class ThreadTrem2 extends Thread {
  ...
  private int solucao; 
  private int processo =1; // numero do processo
  ...
  public ThreadTrem2(ImageView imageTrem, int posicao , Slider slider , int solucao) {
...
/*
  ...
  public void moverTrem(){
    switch (posicao) {
    ...
    else if (this.getImageTrem().getLayoutY() <= 331 && this.getImageTrem().getLayoutY() > 308) {
      ...
      this.getImageTrem().setRotate(220);
    } // fim do segundo if

    else if (this.getImageTrem().getLayoutY() <= 308 && this.getImageTrem().getLayoutY() > 297) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() - this.getSpeedX());
      this.getImageTrem().setRotate(270);
    } // fim do terceiro if
    else if (this.getImageTrem().getLayoutY() <= 297 && this.getImageTrem().getLayoutY() > 251) {
       
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
    } // fim do quarto if
    else if (this.getImageTrem().getLayoutY() <= 251 && this.getImageTrem().getLayoutY() > 232) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(320);
    } // fim do quinto if
    else if (this.getImageTrem().getLayoutY() <= 232 && this.getImageTrem().getLayoutY() > 223) {
       saiZonaCritica1(solucao);
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(270);
    } // fim do sexto if
    else if (this.getImageTrem().getLayoutY() <= 223 && this.getImageTrem().getLayoutY() > 176) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
    } // fim do setimo if
    else if (this.getImageTrem().getLayoutY() <= 176 && this.getImageTrem().getLayoutY() > 155) {
    ...
    else if (this.getImageTrem().getLayoutY() <= 155 && this.getImageTrem().getLayoutY() > 148) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() - this.getSpeedX());
      this.getImageTrem().setRotate(270);
    } // fim do oitavo if
    else if (this.getImageTrem().getLayoutY() <= 148 && this.getImageTrem().getLayoutY() > 92) {
      
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
    } // fim do nono if
    else if (this.getImageTrem().getLayoutY() <= 92 && this.getImageTrem().getLayoutY() > 78) {
      saiZonaCritica2(solucao);
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(320);
    } // fim do decimo if
    else if (this.getImageTrem().getLayoutY() <= 78 && this.getImageTrem().getLayoutY() > 70) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(270);
    } // fim do decimo primeiro if
    else if (this.getImageTrem().getLayoutY() <= 70 && this.getImageTrem().getLayoutY() > -40) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() - this.getSpeedY());
    } // fim do decimo segundo if
    else {
      this.getImageTrem().setLayoutX(314);
  ...
  case 3:{
       if (this.getImageTrem().getLayoutY() < 40 && this.getImageTrem().getLayoutY() > -50) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
    } // fim do primeiro if
    ...
    else if (this.getImageTrem().getLayoutY() < 66) {
        if(!entraZonaCritica2(solucao) && !zonaCritica2){
        break;
      }
    ...
    } else if (this.getImageTrem().getLayoutY() < 120) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
    } // fim do terceiro if
    else if (this.getImageTrem().getLayoutY() < 136) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(45);
    } // fim do quarto if
    else if (this.getImageTrem().getLayoutY() < 150) {
      saiZonaCritica2(solucao);
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(90);
    } // fim do quinto if
    else if (this.getImageTrem().getLayoutY() < 195) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
    } // fim do sexto if
    else if (this.getImageTrem().getLayoutY() < 216) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() - this.getSpeedX());
      this.getImageTrem().setRotate(135);
    } // fim do setimo if
    else if (this.getImageTrem().getLayoutY() < 224) {
        if( !entraZonaCritica1(solucao) && !zonaCritica1){
        break;
      }
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
    ...
    else if (this.getImageTrem().getLayoutY() < 276) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
    } // fim do nono if
    else if (this.getImageTrem().getLayoutY() < 294) {
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(45);
    } // fim do decimo if
    else if (this.getImageTrem().getLayoutY() < 303) {
      saiZonaCritica1(solucao);
      this.getImageTrem().setLayoutY(this.getImageTrem().getLayoutY() + this.getSpeedY());
      this.getImageTrem().setLayoutX(this.getImageTrem().getLayoutX() + this.getSpeedX());
      this.getImageTrem().setRotate(90);
      ...
      this.getImageTrem().setLayoutX(305);
