...
1. **Variável de Travamento**: Implementação inicial para bloquear e desbloquear as zonas críticas manualmente.
2. **Estrita Alternância**: Algoritmo que alterna o acesso entre os trens, garantindo a exclusão mútua.
3. **Solução de Peterson**: Versão otimizada e mais eficiente para evitar deadlocks e garantir a entrada ordenada nas zonas críticas.
